...
Este projeto mantém a estrutura original, e as funcionalidades da lógica de programação foram corretamente implementadas e testadas.

## FUNCIONALIDADES

- A lógica de programação foi mantida e validada com testes, garantindo que todas as funcionalidades estão corretas e funcionando conforme o esperado.
  
## ADICIONAIS

- Foi adicionada uma tela de frontend para exibir o projeto em execução. A interface foi projetada para fornecer uma visualização clara e funcional do sistema.

## COMO RODAR O PROJETO

### Requisitos:
- Verifique se as portas configuradas no arquivo .env estão disponíveis no seu ambiente.
...
A aplicação estará disponível no navegador na porta configurada no .env.
